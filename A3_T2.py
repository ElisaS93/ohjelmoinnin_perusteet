...
if (Char in Word1):
    ...
    print(f"Word \"{Word1}\" does not contain character \"{Char}\"")
...
if (Word1 < Word2):
    print(f"Fird word \"{Word1}\" is before the second word \"{Word2}\" alphabetically.")
elif (Word2 < Word1):
    print(f"Second word \"{Word2}\" is before the first word \"{Word1}\" alphabetically.")
else:
